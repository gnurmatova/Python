#this code is taken from the url below and modified for educational purpose
#https://github.com/Rotten194/summarize.py/blob/master/summarize/summarize.py
...
print(summarize_page("https://en.wikipedia.org/wiki/Tashkent"))
